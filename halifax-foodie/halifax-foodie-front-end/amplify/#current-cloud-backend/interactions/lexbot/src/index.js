...
exports.handler = function(event, context) {
    ...
    let intentParams = [
        ...
        {
            "name": "TrackOrder" + "_" + process.env.ENV,
            ...
            "slots": [
                
                {
                    ...
                    "valueElicitationPrompt": {
                        ...
                        "messages": [
                            {
                                "content": "Can you please mention the Order id?",
                ...
                
                {
                    ...
                    "slotConstraint": "Required",
                    "priority": 1,
                    "slotType": "RestaurantName",
                    "slotTypeVersion": "$LATEST",
                    "valueElicitationPrompt": {
                        "maxAttempts": 3,
                        "messages": [
                            {
                                "content": "Can you please mention Restaurant name?",
                                "contentType": "PlainText"
                            }
                        ]
                    }
                ...
                
                {
                    ...
                    "valueElicitationPrompt": {
                        ...
                        "messages": [
                            {
                                "content": "Can you please tell us the time of order?",
                                "contentType": "PlainText"
                            }
                        ]
                    }
    ...
    let botParams = {
        ...
        "intents": [
            ...
            {
                "intentName": "TrackOrder" + "_" + process.env.ENV,
...
function ensureLambdaFunctionAccess(intent){
    if(intent.fulfillmentLambda){
        ...
        const params = {
            ...
            StatementId: `Lex-${intent.name}`+ "5360918e",
